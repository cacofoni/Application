...
(function() {
  ...
  App.room = App.cable.subscriptions.create("RoomChannel", {
    ...
    received: function(data) {
      ...
      $(".notice").text("Wait your turn");
      return setTimeout(disableTextBox, 3333);
    },
  ...
  disableTextBox = function() {
    return $("textarea").css('background-color', 'white').prop('disabled', false);
  };

  $(".notice").text("HOMIES ARE CHILLING IN THE MARKET");
