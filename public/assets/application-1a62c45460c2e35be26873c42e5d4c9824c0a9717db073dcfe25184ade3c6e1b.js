...
(function() {
  ...
  setNotice = function(indicator) {
    ...
    if (indicator === "success") {
      phrases = ["You win!", "Success!", "Woooooohoooooo!", "Your comment was successfully submitted!", "Winner winner chicken dinner..", "They wish they could be like you", "Easy peasy lemon squeezy", "Easy", "You could do this in your sleep", "Congrats, you win!"];
